...
collect_ignore = ["__init__.py", "legacy_code/__init__.py"]
...
# Add legacy_code to path for backward compatibility
legacy_code_path = project_root / "legacy_code"
if legacy_code_path.exists() and str(legacy_code_path) not in sys.path:
    sys.path.insert(0, str(legacy_code_path))
